...
public interface ImageProgressListener {
    ...
    /**
     * This method gets called as part of the Firebase Storage image upload/download process. It's supposed to provide a callback interface to update any progress bars whilst downloading or uploading a file.
